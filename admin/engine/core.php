...
class CORE
{
	...
	public function DatabaseConnection()
	{
		...
		{
			warcry_render_database_error('Database connection error', 'We were unable to connect to the website database.', 'configuration/database.php', !empty($this->config['DEBUG']), $e->getMessage());
		}
	...
	public function AuthDatabaseConnection()
	{
		...
		{
			warcry_render_database_error('Authentication failed', 'Failed to connect to the authentication database.', 'configuration/authentication.php', !empty($this->config['DEBUG']), $e->getMessage());
		}
