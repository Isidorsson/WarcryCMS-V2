...
class CURUSER extends CORE
{
	...
	public function logInfoAtLogin($acc)
	{
		...
		$previousAdminLogin = (!empty($row['admin_last_login2']) && $row['admin_last_login2'] !== '0000-00-00 00:00:00') ? $row['admin_last_login2'] : $thislogin;
		$update->bindParam(':lastlogin', $previousAdminLogin, PDO::PARAM_STR);
