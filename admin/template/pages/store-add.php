        ...
        <div class="form">
            ...
            <form method="post" action="<?php echo $config['BaseURL']; ?>/admin/execute.php?take=add_storeitem" name="addItemForm" id="add-item">
                ...
                <section>
                  	...
                  	<div>
                    	<input id="label4" name="realm" type="text" class="required" value="1" />
                  	</div>
                </section>
                ...
                <section>
                  	...
                  	<div>
                        ...
                        <input name="displayid" type="hidden" class="item-displayid" value="0" />
                        <input name="icon" type="hidden" class="item-icon" value="inv_misc_questionmark" />
                        <div id="item-icon-preview" style="margin-top:8px;display:none;"><img src="" style="width:38px;height:38px;border-radius:6px;border:1px solid #d4af37;vertical-align:middle;margin-right:8px;"><span></span></div>
                  	</div>
                </section>
...
<script type="text/javascript">
	...
	function ItemAutofill()
	{
		...
		$.get("<?php echo $config['BaseURL']; ?>/admin/ajax.php?phase=20",
		{
			entry: entry
		},
		function(data)
		{
			...
			var displayid = data.displayid || 0;
			...
			$('.item-displayid').val(displayid);
			var iconName = (data.icon || 'inv_misc_questionmark').toLowerCase();
			$('.item-icon').val(iconName);
			$('#item-icon-preview img').attr('src', 'https://wow.zamimg.com/images/wow/icons/large/' + iconName + '.jpg');
			$('#item-icon-preview span').text(iconName + ' / displayid ' + displayid);
			$('#item-icon-preview').show();
