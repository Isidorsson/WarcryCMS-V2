...
// Prefer explicit topic id from the URL, fallback to the last viewed topic.
$topicId = isset($_GET['topic']) ? (int)$_GET['topic'] : (isset($_GET['id']) ? (int)$_GET['id'] : WCF::getLastViewedTopic());
if ($topicId)
{
