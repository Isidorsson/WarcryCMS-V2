...
class PHPMailer {
   ...
   * by SERVER_NAME is used or '192.168.1.2.localdomain'.
   * @var string
   */
  public $Hostname          = '';
 ...
 */
  ...
  */
  ...
  /**
   * Returns the server hostname or '192.168.1.2.localdomain' if unknown.
   * @access private
   * @return string
   */
  private function ServerHostname() {
    if (!empty($this->Hostname)) {
      ...
      $result = '192.168.1.2.localdomain';
    }
